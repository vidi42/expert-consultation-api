...
public interface DocumentService {
    ...
    DocumentConsolidated create(final DocumentViewDto document, final MultipartFile file);

    //update a single document
    Optional<DocumentConsolidated> update(final String id, final DocumentViewDto document, final MultipartFile multipartFile);
